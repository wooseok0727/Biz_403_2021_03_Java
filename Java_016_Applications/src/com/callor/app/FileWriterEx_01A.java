...
public class FileWriterEx_01A {
	...
	public static void main(String[] args) {
		 ...
		 * project/src 폴더 이후 패키지 이름으로 만들어진다
		 * 새로운 파일을 만들기 위해서
		...
		try {
			...
			// PrintWriter을 닫으면 FileWriter도 같이 닫히기 때문에
