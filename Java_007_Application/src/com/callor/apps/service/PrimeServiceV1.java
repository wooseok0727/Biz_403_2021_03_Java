...
public class PrimeServiceV1 {
	...
	// 어떤 변수를 사용하여 프로젝트를 수행할것인가 
	// 여러개(2개이상)의 method에서 공통으로 사용할 변수들은
	...
	//    void 키워드를 사용하지 않는다
	//    이름이 클래스 이름과 같다
	// intNums배열을 설정(초기화, 갯수지정)을 하여
	// 사용할 준비
	public PrimeServiceV1() { // Ctrl + Space
		intNums = new int[20];
	}
