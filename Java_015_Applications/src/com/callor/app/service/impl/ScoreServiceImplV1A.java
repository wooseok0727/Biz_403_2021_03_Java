 ...
 * 			이 return 된 학생이름을 inputScore() 에서
 * 			변수에 담아 처리를 할 수 있다
 */
public class ScoreServiceImplV1A implements ScoreService {
	...
	/*
	 * 현재 클래스 내부에서만 호출되는 method는 private으로 선언한다
	 * 현재 클래스를 상속받아 확장하여 사용할 수 있도록 하려면
	 * private => protected로 변경 해주어야 한다
	 */
	...
	public void inputScore() {
		 ...
		 * 영어, 수학 점수를 입력받는 Prompt가 나타나고 3과목을
		 * 모두 통과 한 후 입력종료 된다
		 */
