...
public class ScoreServiceImplV2B extends ScoreServiceImplV1A {

	/*
	 * scoreList에 성적정보를 추가할 때 
	 * 학번을 입력받을텐데
	 * 이미 등록된 학번 정보가 있으면 그 학번은 추가 하지 못하도록
	 * 하는 코드
	 * 
	 * V1A의 inputNum() method를 재 정의 한다
	 * V1A의 inputNum() method를 재 정의 하기 하여
	...
	protected String inputNum() {
		...
		while(true) {
			...
			// 아니면 중간에 중단되고 빠져나왔는가 ? : index < size()
