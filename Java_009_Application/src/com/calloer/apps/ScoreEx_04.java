...
import com.calloer.apps.model.ScoreVO;
import com.calloer.apps.service.ScoreServiceV2;
import com.calloer.apps.service.ScoreServiceV5;
...
public class ScoreEx_04 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 기본 변수 선원 키워드(primitive variable key word) int, long, double, float, boolean,
		 * char
		 * 
		 * 기본 변수와 사용법이 같은 클래스 wrapper class : 기본 변수를 감싸고 기능을 확장한다 라는 뜻 Integer, Long,
