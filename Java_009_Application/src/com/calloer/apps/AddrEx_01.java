...
import com.calloer.apps.model.AddressVO;
import com.calloer.apps.service.AddressServiceV1;
...
public class AddrEx_01 {
	...
	public static void main(String[] args) {
		...
		홍길동.email = "aaaa@naver.com";
		홍길동.chain = "친구";
		홍길동.address = "서울특별시";
	
		AddressServiceV1 ssV1 = new AddressServiceV1();
		ssV1.printAddress("홍길동", "eamil", "010-111-1111");
		System.out.println("=======================");
