package com.calloer.apps.model;
...
public class ScoreVO {
	 ...
	 * 연산한 후 연산결과를 저장하기 위한 변수이다
	 *
	 * ko, eng math는 어디에서든지 저장, 읽기가 가능한
