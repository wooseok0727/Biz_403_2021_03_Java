...
public class Variable_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 결과를 저장하는 기억자송도 5개 사용한다.
		 * 
		 * 불과 5번의 명령수행을 위하여 기억장치를 15개 낭비하게 된다.
		 * 
		 * 30과 40이라는 두 숫자를 어떤 지정된 기억장소에 보관해 두고
		 * 연산할때 그 값을 참조하여 연산을 하도록 한다면
		 * 기억장치를 효율적으로 사용할수 있을것이다.
		 * 
		 * 이러한 개념을 발전 시킨것을 "변수(Variable)" 이라고 한다.
		 */
	}
}
